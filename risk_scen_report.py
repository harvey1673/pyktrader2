...
def run_book_report(value_date, book_name, fwd_idx = 'SGXIRO'):
    ...
    req_greeks = ['pv','cmdelta','cmgamma','cmvega_atm', 'cmvega_v90', 'cmvega_v75', 'cmvega_v25', 'cmvega_v10', 'theta']
    ...
    for deal in book.deal_list:
        ...
        for greek in ['cmdelta', 'cmvega_atm', 'cmvega_v90', 'cmvega_v75', 'cmvega_v25', 'cmvega_v10', 'cmgamma']:
    ...
    vega_tbl = df.pivot_table(columns=['otype', 'strike'], index=['end'], values=['cmvega_atm'], aggfunc = 'sum')
