...
product_code = {'SHFE': ['cu', 'cu_Opt', 'al', 'zn', 'pb', 'wr', 'rb', 'fu', 'ru', 'ru_Opt', 'bu', 'hc', 'ag', 'au', 'sn', 'ni', 'sp'],
                'CFFEX': ['IF', 'TF', 'IO', 'T', 'TS', 'IH', 'IC'],
                'DCE': ['c', 'c_Opt', 'cs', 'j', 'jd', 'a', 'b', 'm', 'm_Opt', 'y', 'p', 'l', 'v', 'jm', 'i', 'fb', 'bb', 'pp', 'eg'],
                'CZCE': ['ER', 'RO', 'WS', 'WT', 'WH', 'PM', 'CF', 'CF_Opt', 'CY', 'SR', 'SR_Opt', 'TA', 'OI', 'RI', 'ME', 'FG',
...
option_market_products = ['Stock_Opt', 'ETF_Opt', 'IO', 'm_Opt', 'SR_Opt', 'cu_Opt', 'ru_Opt', 'CF_Opt', 'c_Opt']
